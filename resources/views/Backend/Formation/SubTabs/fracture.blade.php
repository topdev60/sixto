                ...
                <div class="card-header clearfix">
                    ...
                    <div class="float-end">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{route('admin.fgpressure.export', session()->get('projectId'))}}"> {{__('Export to Excel')}} </a></li>
                            <li><a class="dropdown-item" href="{{route('admin.fgpressure.destroyAllRows', session()->get('projectId'))}}"> {{__('Delete All Rows')}} </a></li>
                        </ul>   
                    </div>
                </div>
