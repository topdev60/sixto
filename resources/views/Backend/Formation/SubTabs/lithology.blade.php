                ...
                <div class="card-header clearfix">
                    ...
                    <div class="float-end">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="javascript:void(0)" onclick="pasteLithologyFunc()"> {{__('Paste from Clipboard')}} </a></li>
                            <li><a class="dropdown-item" href="{{route('admin.lithology.export', session()->get('projectId'))}}"> {{__('Export to Excel')}} </a></li>
                            <li><a class="dropdown-item" href="{{route('admin.lithology.destroyAllRows', session()->get('projectId'))}}"> {{__('Delete All Rows')}} </a></li>
                        </ul>
                    </div>
                </div>
