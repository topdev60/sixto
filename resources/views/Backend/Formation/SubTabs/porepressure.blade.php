                ...
                <div class="card-header clearfix">
                    ...
                    <div class="float-end">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{route('admin.porepressure.export', session()->get('projectId'))}}"> {{__('Export to Excel')}} </a></li>
                            <li><a class="dropdown-item" href="{{route('admin.porepressure.destroyAllRows', session()->get('projectId'))}}"> {{__('Delete All Rows')}} </a></li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <td class="text-center"> 
                                        ...
                                        <div class="modal fade" id="delete{{ $item->PP_ID }}" data-bs-backdrop="static"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.porepressure.destroy') }}" method="post" id="delete{{ $item->PP_ID }}">
                                                    @csrf
