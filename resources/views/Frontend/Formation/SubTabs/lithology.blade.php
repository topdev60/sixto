                ...
                <div class="card-header clearfix">
                    ...
                    <div class="float-end">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{route('user.lithology.export', session()->get('projectId'))}}"> {{__('Export to Excel')}} </a></li>
                            <li><a class="dropdown-item" href="{{route('user.lithology.destroyAllRows', session()->get('projectId'))}}"> {{__('Delete All Rows')}} </a></li>
                        </ul>
                    </div>
                </div>
